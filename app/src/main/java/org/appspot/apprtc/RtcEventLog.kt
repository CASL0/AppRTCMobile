...
class RtcEventLog(private val peerConnection: PeerConnection) {
    ...
    fun start(outputFile: File) {
        if (state == RtcEventLogState.STARTED) {
            Log.e(
                TAG,
                "org.appspot.apprtc.RtcEventLog has already started."
            )
            return
        }
        ...
        Log.d(
            TAG,
            "org.appspot.apprtc.RtcEventLog started."
        )
    }
    ...
    fun stop() {
        if (state != RtcEventLogState.STARTED) {
            Log.e(
                TAG,
                "org.appspot.apprtc.RtcEventLog was not started."
            )
            return
        }
        ...
        Log.d(
            TAG,
            "org.appspot.apprtc.RtcEventLog stopped."
        )
    }
